	...
	document.getElementById("zeitgeber_stunden").innerHTML = zeitgeber_input_hours.toString().padStart(2, '0');
	document.getElementById("zeitgeber_minuten").innerHTML = zeitgeber_input_minutes.toString().padStart(2, '0');
	document.getElementById("zeitgeber_sekunden").innerHTML = zeitgeber_input_seconds.toString().padStart(2, '0');
	...
	function zeitgeber_druck_zeit(){
		...
		document.getElementById("zeitgeber_stunden").innerHTML = (zeitgeber_verstrichene_zeit_stunden.toString()).padStart(2, '0');
		document.getElementById("zeitgeber_minuten").innerHTML = (zeitgeber_verstrichene_zeit_minuten.toString()).padStart(2, '0');
		document.getElementById("zeitgeber_sekunden").innerHTML = (zeitgeber_verstrichene_zeit_sekunden.toString()).padStart(2, '0');
	...
	function zeitgeber_pause(){
		...
		document.getElementById("zeitgeber_pause_btn").innerHTML  = (zeitgeber_zustand == 'pause') ? 'fortsetzen' : 'Pause';
	}
